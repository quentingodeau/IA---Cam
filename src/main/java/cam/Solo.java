...
public class Solo {
    ...
    private final static int BLANC = IJoueur.BLANC;
    private final static int NOIR = IJoueur.NOIR;
	...
	while (!partieFinie) {
	    ...
	    System.out.println("On demande à " + joueurCourant.binoName() + " de jouer...");
	...
	System.out.println("Partie solo de Cam...");
